...
import { facebook, telegram, x, vk, copy_link } from "../../assets/img"; // Rasm importlari
...
export default function Post(): JSX.Element {
  ...
  // Maqola kontentini tozalash va skriptlarni yuklash
  useEffect(() => {
    if (postSingle) {
      ...
      // 3 soniyadan keyin `cleanContent`ni o'rnatish
  ...
  // Asosiy kontent uchun o'zgaruvchilar
  const post = postSingle?.data;
        ...
        <>
          ...
          <div className="detail_container container flex flex-col">
            ...
            <div
              ...
              dangerouslySetInnerHTML={{ __html: cleanContent }} // HTMLni chiqarish
            />
